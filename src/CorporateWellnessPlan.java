public class CorporateWellnessPlan extends MembershipPlan implements RemoteAccess, Freezable {
    ...
    @Override
    public String getPlanType() { return "Corporate Wellness"; }
    ...
    @Override
    public boolean hasOnlineAccess() { return onlineDashboard; }
    ...
    public String toString() {
        return super.toString() + ", Employees: " + employeeCount + ", Workshops: " + workshopsPerMonth;
    }
}
