public class OnlineCoachingPlan extends MembershipPlan implements RemoteAccess {
    ...
    @Override
    public String getPlanType() { return "Online Coaching"; }
    ...
    @Override
    public boolean hasOnlineAccess() { return true; }

    @Override
    public String toString() {
        return super.toString() + ", Video Consultations: " + videoConsultations;
    }
}